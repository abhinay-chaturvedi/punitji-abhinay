      ...
      <Container>
        ...
        <Box sx={{ display: "flex", flex: 1, flexDirection: "column", gap: "10px" }}>
          ...
          <Typography sx={{ fontWeight: "600", color: "gray" }}>
            ...
            competition is our team of highly skilled professionals who possess
            extensive knowledge and expertise in immigration matters. Our track
            record speaks for itself, as we have successfully assisted numerous
            individuals and families in achieving their immigration goals. We
            are proud of the positive feedback and testimonials we have received
            from our satisfied clients, which further validate our commitment to
            excellence. Thank you for considering our company for immigration
            needs. We look forward to the opportunity to serve you and
            demonstrate why we are the best choice of your immigration services.
          </Typography>
