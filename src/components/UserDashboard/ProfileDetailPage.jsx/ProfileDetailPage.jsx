...
const ProfileDetailPage = () => {
  ...
  return (
    <Box>
      <MainApplication userState={userState} mainApplicationDetail={mainApplicationDetail} setMainApplicationDetail={setMainApplicationDetail}/>
      <Education userState={userState} mainApplicationDetail={mainApplicationDetail}/>
      <WorkExperience userState={userState}/>
      <LanguageTest userState={userState}/>
    </Box>
  )
}
